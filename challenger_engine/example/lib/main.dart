            ...
            TextButton(
              onPressed: _working
                  ...
                  : () async {
                      ...
                      await engine.waitResponse(['ucciok'], sleep: 100, times: 200);
            ...
            TextButton(
              onPressed: _working
                  ...
                  : () async {
                      ...
                      await engine.waitResponse(['bestmove', 'nobestmove'], sleep: 100, times: 200);
                      setState(() => _working = false);
                    },
              child: const Text('Go'),
            ),
            TextButton(
              onPressed: _working
                  ...
                  : () async {
                      ...
                      await engine.waitResponse(['bye'], sleep: 100, times: 200);
                      setState(() => _working = false);
                    },
