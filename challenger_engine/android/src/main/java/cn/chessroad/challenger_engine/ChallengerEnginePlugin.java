...
/** ChallengerEnginePlugin */
public class ChallengerEnginePlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "challenger_engine");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    ChallengerEngineNative engine = new ChallengerEngineNative();
