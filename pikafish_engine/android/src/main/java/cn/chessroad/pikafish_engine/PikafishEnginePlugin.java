...
public class PikafishEnginePlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "pikafish_engine");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    PikafishEngineNative engine = new PikafishEngineNative();
